          ...
          <div className='phy-cha'>
            ...
            <div className="card-content">
                ...
                <div className='viewcha'>
                    <Link to = '/coach-index/challenges/arms' className='phy-viewcha-button'>View Challenge</Link>
                </div>
            </div>
        </div>
        <div>
            <div className="card-content">
                ...
                <div className='viewcha'>
                    <Link to = '/coach-index/challenges/abs' className='phy-viewcha-button'>View Challenge</Link>
                </div>
            </div>
        </div>
        <div>
            <div className="card-content">
                ...
                <div className='viewcha'>
                    <Link to = '/coach-index/challenges/cardio' className='phy-viewcha-button'>View Challenge</Link>
                </div>
            </div>
        </div>
        <div>
            <div className="card-content">
                ...
                <div className='viewcha'>
                    <Link to = "/coach-index/challenges/strength" className='phy-viewcha-button'>View Challenge</Link>
                </div>
                </div>
            </div>
          ...
          <div className='ment-cha'>
            ...
            <div className="card-content">
              ...
              <div className='viewcha'>
                <Link to = '/coach-index/challenges/memory'className='men-viewcha-button'>View Challenge</Link>
              </div>
            </div>
            </div>
            <div>
            <div className="card-content">
              ...
              <div className='viewcha'>
                <Link to = '/coach-index/challenges/math' className='men-viewcha-button'>View Challenge</Link>
              </div>
            </div>
            </div>
            <div>
            <div className="card-content">
              ...
              <div className='viewcha'>
                <Link to = '/coach-index/challenges/breathing' className='men-viewcha-button'>View Challenge</Link>
              </div>
            </div>
            </div>
            <div>
            <div className="card-content">
              ...
              <div className='viewcha'>
                <Link to = '/coach-index/challenges/concentration' className='men-viewcha-button'>View Challenge</Link>
              </div>
            </div>
            </div>
            </Slider>
