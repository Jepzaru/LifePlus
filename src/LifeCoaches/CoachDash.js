        ...
        <>
          ...
          <div className={`recen-cha ${darkMode ? 'dark-mode-title' : ''}`}>
            ...
            <div className='rec-com'>
                ...
                <div className='arms-chale'>
                  <div className='cha-ngan'>
                <h4>Arms Challenge</h4>
                </div>
                <div className='progess-circ'>
                <CircularProgressbar
                    value={0} 
                    text={`${0}%`} 
                    strokeWidth={15} 
                  ...
                  />
                    ...
                    <div className='viewcha-btn'>
                  <Link to="/coach-index/challenges/arms">
                    <button className='armscha'>View Challenges</button>
                  </Link>
                  </div>
                </div>
                <div className='arms-chale'>
                <div className='cha-ngan'>
                <h4>Strength Challenge</h4>
                </div>
                <div className='progess-circ'>
                <CircularProgressbar
                    value={0} 
                  ...
                  <div className='viewcha-btn'>
                  <Link to="/coach-index/challenges/strength">
                    <button className='armscha'>View Challenges</button>
                  </Link>
                  </div>
                </div>
                ...
                <CircularProgressbar
                  ...
                  <div className='viewcha-btn'>
                  <Link to="/coach-index/challenges/abs">
                    <button className='armscha'>View Challenges</button>
                  </Link>
                  </div>
                </div>
                ...
                <CircularProgressbar
                  ...
                  <div className='viewcha-btn'>
                  <Link to="/coach-index/challenges/cardio">
                    <button className='armscha'>View Challenges</button>
                  </Link>
                  </div>
                </div>
                ...
                <CircularProgressbar
                  ...
                  <div className='viewcha-btn'>
                  <Link to="/coach-index/challenges/breathing">
                    <button className='armscha'>View Challenges</button>
                  </Link>
                  </div>
                </div>
                ...
                <CircularProgressbar
                  ...
                  <div className='viewcha-btn'>
                  <Link to="/coach-index/challenges/concentration">
                    <button className='armscha'>View Challenges</button>
                  </Link>
                  </div>
                </div>
                ...
                <CircularProgressbar
                  ...
                  <div className='viewcha-btn'>
                  <Link to="/coach-index/challenges/math">
                    <button className='armscha'>View Challenges</button>
                  </Link>
                  </div>
                </div>
                ...
                <CircularProgressbar
                  ...
                  <div className='viewcha-btn'>
                  <Link to="/coach-index/challenges/memory">
                    <button className='armscha'>View Challenges</button>
                  </Link>
                  </div>
                </div>
